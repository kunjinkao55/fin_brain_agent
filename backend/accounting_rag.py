...
_INDUSTRY_TEMPLATES = [
    ...
    },
    {
        ...
        "title": "能源/电力分析模板",
        "content": (
            "【周期股分析铁律 — 适用于有色/化工/电力/钢铁/航运】"
"1. 区分'真差'和'差到不能再差': 毛利率从3%提升到5%、营收+57%、动态PE仅13倍=底部反转。毛利率从30%下滑到28%、营收持平=护城河侵蚀。前者比后者更有投资价值。"
"2. 禁止仅因毛利率低就判'谨慎': 低毛利+高增速=规模效应释放,应给积极评级。高毛利+增速停滞=竞争加剧。"
"3. 强制检查营收增速vs PE匹配度: 营收增速>30%且动态PE<15倍→存在低估。营收增速<5%且PE>20倍→偏贵。"
"4. 周期底部反转信号: 营收连续2季加速+毛利率触底回升+产能利用率提升(营收增速推演)→复苏初期,估值应给溢价而非折价。"
"5. 新材料/新业务重估: 若发现有新材料(如高纯金属/靶材)相关收入,需单独评估——新材料给25-30倍PE,冶炼只给10倍。加权计算合理估值。"
""
