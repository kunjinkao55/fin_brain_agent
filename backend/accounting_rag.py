...
_INDUSTRY_TEMPLATES = [
    ...
    {"id": "ind_it_services", "title": "软件/IT服务行业模板",
     "content": (
        "【行业周期】IT服务弱周期但受客户资本开支节奏影响：政企IT预算年初制定、年末集中确认收入，利润高度集中在Q4，Q1占比常不足全年10%——单季年化严重失真，必须用TTM或全年视角。"
        "电网信息化/能源数字化:投资主体为国网/南网，十四五-十五五期间年均千亿级投入，需求确定性高但招标价格年降。"
        "【估值规律】成熟IT服务(行业解决方案商):PE 20-35倍。高成长SaaS/产品型:PE 40-60倍或PS 5-15倍。项目制公司(集成商):PE 15-25倍，毛利率低于25%时估值折价。"
        "政企IT商利润率薄(净利率5-10%)，估值看订单增速+毛利率拐点，不看点位PE。业绩快报是重要校验点:Q1占全年比例低，Q1亏损或暴跌多为季节性，半年度快报扣非同比是趋势判断的关键证据。"
        "【竞争格局】行业分散:电网信息化(国网信通/朗新/远光)、政务IT(太极/浪潮)、金融IT(恒生/宇信)。壁垒=行业Know-how+客户资质+案例积累，而非纯技术。竞争加剧期毛利率普遍下滑3-5pp。"
        "【产业链位置】上游:华为/浪潮等硬件+基础软件;中游:解决方案商(集成+定制开发);下游:政企大客户。中游议价能力弱，应收账款常达年收入50%以上——应收账款/净利润比是核心风险指标，信用减值可直接吞噬年度利润。"
        "【关键指标】在手订单额及转化周期、新签订单增速、毛利率趋势(3年)、应收账款周转天数、经营性现金流/净利润(项目制公司回款年末集中，Q1-Q3为负常见)、人均产值。"
    )},
]
...
_STOCK_SLANG = [
    {"id": "slang_01", "title": "基本面术语",
     "content": "【基本面】对应黑话：'看底子'/'扒光衣服看'（深度分析财报）。'业绩炸裂'=利润暴增。'暴雷'=业绩大幅低于预期或财务造假。'洗澡'=财务大洗澡，一次性计提大量减值损失。'注水'=利润造假。'挤水分'=去杠杆或消化坏账。"},
    {"id": "slang_02", "title": "估值相关",
     "content": "【估值】对应黑话：'便宜货'/'白菜价'=PE很低。'贵得离谱'/'飞天'=PE极高。'杀估值'=股价下跌只因PE压缩而非业绩变差。'戴维斯双击'=业绩+估值同时提升→股价暴涨。'戴维斯双杀'=业绩+估值同时下降→股价暴跌。'估值修复'=PE从低位回到合理水平。"},
    {"id": "slang_03", "title": "涨跌形态",
     "content": "【涨跌】对应黑话：'起飞'/'火箭'=股价暴涨。'跳水'/'瀑布'=股价急跌。'一字板'=开盘即涨停/跌停，全天无波动。'天地板'=涨停→跌停。'地天板'=跌停→涨停。'磨底'=底部长期横盘。'突破'=股价突破关键阻力位。'破位'=跌破关键支撑。'深V'=暴跌后快速拉回。"},
    {"id": "slang_04", "title": "持仓与择时",
     "content": "【操作】对应黑话：'上车'=买入建仓。'下车'=卖出离场。'抄底'=在底部买入。'追高'=在高位买入。'站岗'/'山顶吹风'=高位买入后被套。'割肉'=亏损卖出止损。'深套'=亏损幅度很大。'做T'=日内高抛低吸。'躺平'=持仓不动装死。'定投'=定期定额买入，摊平成本。'一把梭'=一次性全仓买入。'满仓'=全部资金买入。'空仓'=全部卖出持币。"},
    {"id": "slang_05", "title": "市场情绪",
     "content": "【情绪】对应黑话：'牛市'/'大牛'=持续上涨行情。'熊市'/'大熊'=持续下跌行情。'猴市'=上蹿下跳震荡市。'吃肉'=赚大钱。'吃面'=亏钱（源自关灯吃面典故）。'踏空'=看涨但没买，错失涨幅。'套牢'=买入后持续下跌无法脱身。'韭菜'=反复被割的散户。'主力'/'庄家'=大资金机构。'游资'=短线炒作资金。'北向资金'=沪深港通外资。'国家队'=证金汇金等国有资金。'护盘'=大资金托市。"},
    {"id": "slang_06", "title": "行业与题材",
     "content": "【题材】对应黑话：'赛道'=行业或板块。'龙头'/'大白马'=行业龙头白马股。'妖股'=短期暴涨暴跌的题材股。'次新'=上市不满一年的新股。'壳资源'=市值小、可被借壳的公司。'概念'/'题材'=热点炒作方向。'风口'=当前最热赛道。'AI铲子股'=卖AI基础设施的公司（如光模块/算力）。'铲子'/'卖水人'=淘金热中卖铲子的人→不直接参与但确定性受益。"},
    {"id": "slang_07", "title": "盘口与量价",
     "content": "【盘口】对应黑话：'放量'=成交量大幅放大。'缩量'=成交量萎缩。'天量'=成交创历史新高。'地量'=成交创历史新低。'换手率'=日成交/流通股本。'封板'=涨停板封单很大。'炸板'=涨停板被打开。'翘板'=跌停板被打开。'护盘'=主力托盘不让跌。'砸盘'=主力抛售打压股价。"},
    {"id": "slang_08", "title": "盈亏与仓位管理",
     "content": "【仓位】对应黑话：'轻仓'=仓位<30%。'半仓'=仓位约50%。'重仓'=仓位>70%。'浮盈'=账面盈利未兑现。'浮亏'=账面亏损未止损。'止盈'=盈利后卖出锁定利润。'止损'=亏损后卖出控制风险。'回撤'=从最高点到当前的跌幅。'安全垫'=已有浮盈可承受的回撤空间。"},
]

def seed_slang_kb() -> dict:
    """将炒股圈黑话写入 slang 知识库（幂等）。"""
    _ensure_init()
    col = _get_kb_collection("slang")
    existing = col.get()
    existing_ids = set(existing.get("ids", []))
    new_docs, new_ids, new_metas = [], [], []
    skipped = 0
    for item in _STOCK_SLANG:
        if item["id"] in existing_ids:
            skipped += 1
            continue
        new_ids.append(item["id"])
