...
- 若当前处于财报披露窗口→分析中应重点讨论最新业绩对估值的影响
...
- 行业周期：行业高景气度上行→利润弹性释放
- 成长性：市场超预期拓展/新品上市持续超预期→营收增速向上
- 价格弹性：产品价格中枢持续上涨→周期品/制造业最利好
- 以上信号必须与collected_data中的具体数字对应，不可仅凭公司话术
...
- [真假增长判别] 扣非净利润增速优先于归母净利润。若归母暴增而扣非微增→非经常性损益驱动，不可持续。若利润暴增但经营现金流为负→利润含金量存疑。若营收增速远低于利润增速→增长来自成本压缩而非市场扩张，持续性有限。
...
第8步 估值判断（合理价值是多少）:
- [估值透支检查] 景气度再好，若股价已提前透支（如10日涨幅>50%而基本面改善幅度远不及），仍存在回调风险。对比当前PE与行业历史PE中枢、当前PB与每股净资产，判断是否已充分定价。短期暴涨+基本面微利=炒作，需明确标注风险。
- 绝对估值: PE/PB/PS在历史分位
- 相对估值: 与同行业可比公司对比
...
[估值前提检查]
- 扣非优先：若扣非增速远低于归母增速→利润质量存疑，PE折价链中应加"非经常性损益折价"
- 现金流验证：经营现金流长期<净利润→利润含金量不足，PE应打折
- 估值透支：若股价短期涨幅>50%而基本面改善幅度远不及→标注"已透支"
- 财报季时效：1-4月年报+一季报窗口，7-8月半年报窗口，10月三季报窗口——若当前处于窗口期，以最新业绩数据为准
