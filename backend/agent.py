...
- 绝对估值: PE/PB/PS在历史分位
- 相对估值: 与同行业可比公司对比
- 情景估值: 悲观/基准/乐观三种情景，概率加权计算期望价值。⚠️ 核心约束：三种情景的EPS必须与增速假设自洽——增速越高EPS越大。悲观EPS ≤ 基准EPS ≤ 乐观EPS，不得出现悲观26.7元>基准21元的倒挂。
...
3. 检查"风险"中是否包含"定增/减持/负债率>70%/现金流为负"，但"投资决策"是否还是BUY。如果是，标记为"⚠️风险-评级错配"。同样，如果投资决策是SELL但操作建议却给出具体的买入价格和建仓计划，标记为"⚠️评级-操作矛盾: SELL不应包含买入计划，应改为卖出/观望建议或调整评级为HOLD"。
